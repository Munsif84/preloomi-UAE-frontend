  ...
  const t = (key, fallback = key) => {
    const translations = {
      en: {
        ...
        'home.heroDescription': 'Discover unique fashion pieces from Dubai, Abu Dhabi, and across the Emirates. Join the sustainable fashion movement today.',
      ...
      ar: {
        ...
        'home.heroDescription': 'اكتشف قطع أزياء فريدة من دبي وأبوظبي وعبر الإمارات. انضم إلى حركة الأزياء المستدامة اليوم.',
